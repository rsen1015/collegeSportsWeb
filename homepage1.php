...
<div id="myModal" class="modal">
  ...
  <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
	  <li class="nav-item dropdown">
		<div class="btn-group">
		<button type="button" class="btn btn-white"><i class="fa fa-home w3-xlarge"></i> HOME</a>
		</div>
        <div class="btn-group">
			<button type="button" class="btn btn-white"><i class="fa fa-futbol-o w3-large"></i> SPORTS</button>
			<button type="button" class="btn dropdown-toggle dropdown-toggle-split" style="background-color:rgb(74,33,12);color:white;" data-toggle="dropdown"></button>
			<div class="dropdown-menu" style="background-color:rgb(32,16,3)">
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''" href="cric2.php">Cricket</a>
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''" href="#">Football</a>
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''" href="#">Badminton</a>
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''" href="#">Table Tennis</a>
			</div>
		</div>
		<div class="btn-group">
			<button type="button" class="btn btn-white"><i class="fa fa-flag-checkered w3-large"></i> DEPARTMENTS</a>
			<button type="button" class="btn dropdown-toggle dropdown-toggle-split" style="background-color:rgb(74,33,12);color:white;" data-toggle="dropdown"></button>
			<div class="dropdown-menu" style="background-color:rgb(32,16,3)">
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''"  href="#">CSE</a>
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''" href="#">IT</a>
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''" href="#">EE</a>
				<a class="dropdown-item text-white" onmouseover="this.style.backgroundColor='rgb(74,33,12)'" onmouseout="this.style.backgroundColor=''" href="#">ECE</a>
			</div>
		</div>
      </li>
	</ul>
...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	<hr></hr>
        <p style="font-family:Modern No. 20, Times, serif;color:rgb(128,83,42);"><a href="studreg1.php"><i class="fa fa-user-circle-o w3-xlarge" aria-hidden="true"></i><i> Student Registration</i></a></p>
      <hr></hr>
	  <!--hr></hr>
        <p class="text-danger" style="font-family:Modern No. 20, Times, serif"><a href="#"><i>Student Registration</i></a></p>
      <hr></hr-->
    ...
    <div class="col-sm-2 sidenav" style="background: linear-gradient(to bottom,black,black,black, rgb(110,53,16))">
	  ...
	  <hr></hr>
	  <div class="example3">
		<p><h3 style="color:rgb(128,83,42)"><a href="selectionlist.docx">Selection Process Over, Team List Realeased.</a></p>
		<hr></hr>
		<p><a href="selectionlist.docx">Schedule for Cricket Tournament Released</a></p><hr></hr></h3>
		</div>
        <!--p style="color:rgb(0,139,139)"><a href="#">Selection Process Over, Team List Realeased.</a></p>
		<p style="color:rgb(0,139,139)"><a href="#">Schedule for Cricket Tournament Released</a></p-->
    </div>
  </div>
</div>
...
<footer class="container-fluid" style="background: linear-gradient(to bottom,rgb(110,53,16),black,black)">
  ...
  <tr>
    ...
    <td style="padding: 0px 0px 0px 150px;font-size: 16px;"><a href="cric2.php">Cricket</a></td>
